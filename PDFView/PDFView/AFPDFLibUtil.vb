...
Public Class AFPDFLibUtil
    ...
    Public Shared Sub DrawImageFromPDF(ByRef pdfDoc As AFPDFLibNET.AFPDFDoc, ByVal PageNumber As Integer, ByRef oPictureBox As PictureBox)
    ...
    Public Shared Sub PrintPDFImagesToPrinter(ByRef pdfDoc As AFPDFLibNET.AFPDFDoc, ByRef picbox As PictureBox)
        If pdfDoc IsNot Nothing Then
    ...
    Public Shared Function LoadBookmarks(ByRef tvwOutline As TreeView, ByRef pdfDoc As AFPDFLibNET.AFPDFDoc) As Boolean
        Dim ol As AFPDFLibNET.OutlineItemA = Nothing
        ...
        If pdfDoc IsNot Nothing AndAlso pdfDoc.OutlineCount > 0 Then
            ...
            For i As Integer = 1 To pdfDoc.OutlineCount
                ...
                ol = New AFPDFLibNET.OutlineItemA()
    ...
    Public Shared Sub FillTree(ByRef tvwOutline As TreeView, ByRef outline As List(Of PDFOutline))
        tvwOutline.Nodes.Clear()
        If outline IsNot Nothing Then
            For Each ol As PDFOutline In outline
                Dim tn As New TreeNode(ol.Title)
                tn.Tag = ol
                If ol.Item.KidsCount > 0 Then
...
Public Class PDFOutline
    ...
    Public Item As AFPDFLibNET.OutlineItemA
    Friend _doc As AFPDFLibNET.AFPDFDoc = Nothing
    ...
    Friend Sub New(ByVal title__1 As String, ByVal outlineItem As AFPDFLibNET.OutlineItemA, ByVal doc As AFPDFLibNET.AFPDFDoc)
        Title = title__1
        Item = outlineItem
        _doc = doc
    End Sub
    ...
    Friend Sub LoadChildren()
        If _children Is Nothing Then
            ...
            For i As Integer = 1 To Item.KidsCount
                ...
                If lPtr > 0 Then
                    Dim ol As New AFPDFLibNET.OutlineItemA()
                    ol.SetOutlineItemXPDF(lPtr)

...
#Region "Simple Conversion Functions"
  ...
  Public Shared Function ConvertPdfToGraphic(ByVal inputFileName As String, _
    ...
    ConvertPdfToGraphic = ""
    Dim converter As New GhostScriptCmd
  ...
  Public Sub WritePageFromPDF(ByVal inputfilename As String, ByVal outputfilename As String, ByVal PageNumber As Integer, Optional ByVal DPI As Integer = VIEW_DPI, Optional ByVal Password As String = "", Optional ByVal forPrinting As Boolean = False)
    'Dim converter As New ConvertPDF.PDFConvert
    Dim Converted As Boolean = False
    Me.RenderingThreads = Environment.ProcessorCount
    Me.OutputToMultipleFile = False
    ...
    End If
    Me.OutputFormat = COLOR_PNG_RGB
    Converted = Me.Convert(inputfilename, outputfilename)
  End Sub
#End Region
End Class

...
Public Class iTextSharpUtil
    ...
    Private Const BlackNegationThreshold As Single = 0.8
        ...
        Try
            ...
            For Each psFileName As String In psFilenames
                ...
                For k As Integer = StartPage To EndPage
                    ...
                    'Invert 1-bit TIFF files that are mostly black
                    If System.Drawing.Bitmap.GetPixelFormatSize(bm.PixelFormat) = 1 AndAlso ImageUtil.IsTiff(psFileName) Then
                        If ImageUtil.GetBlackPercentage(bm) > BlackNegationThreshold Then
                            ImageUtil.Negative(bm)
                        End If
                    End If
